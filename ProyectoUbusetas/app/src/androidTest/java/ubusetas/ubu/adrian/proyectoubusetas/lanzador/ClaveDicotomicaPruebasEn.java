...
* @category: clase
* @Description: Clase que prueba que los textos de la actividad ClaveDicotomica se muestren correctamente en inglés,
...
public class ClaveDicotomicaPruebasEn {
    ...
    * @Author: Adrián Antón García
    * @category: procedimiento test
    * @Description: Procedimiento que prueba que los textos de la actividad ClaveDicotomica se muestren correctamente en inglés,
    * así como los textos de la clave según se vaya avanzando a través de ella.
    * */
