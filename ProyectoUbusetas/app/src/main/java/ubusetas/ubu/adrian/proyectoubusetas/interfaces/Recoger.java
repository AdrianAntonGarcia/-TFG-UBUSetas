...
public class Recoger extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = Recoger.class.getSimpleName();
            ...
            case R.id.boton_clasificar://BOTÓN CLASIFICAR FOTO
                ...
                if (fotoPath == null) {
                    ...
                    if (resultados != null) {
                        ...
                        Intent cambioActividad = new Intent(Recoger.this, MostrarResultados.class);
