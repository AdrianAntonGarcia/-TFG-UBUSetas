...
/**
 * Clase que prueba que la actividad MostrarSetas se muestre correctamente en inglés.
 * Pulsando todos los elementos y comprobando los textos en inglés.
 *
...
public class MostrarSetasPruebasEn {
    ...
    /**
     * Procedimiento que prueba que la actividad MostrarSetas se muestre correctamente en inglés.
     * Pulsando todos los elementos y comprobando los textos en inglés.
     *
     * @name mostrarSetasPruebasEn
     * @author Adrián Antón García
    ...
    @Test
    public void mostrarSetasPruebasEn() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView_contenido_mostrar_setas), withText("Select a card to display the information of that mushroom:"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Select a card to display the information of that mushroom:")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textView0), withText("Activity help show mushrooms:"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("Activity help show mushrooms:")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.textView1), withText("To select a mushroom and access its information, click on one of the cards."),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("To select a mushroom and access its information, click on one of the cards.")));
        ...
        ViewInteraction textView6 = onView(
                allOf(withId(R.id.nombre_tarjeta_seta), withText("Agrocybe parasitica"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView6.check(matches(withText("Agrocybe parasitica")));
        ...
        ViewInteraction textView7 = onView(
                allOf(withText("Options"),
                        childAtPosition(
                                ...
                                7),
                        isDisplayed()));
        textView7.check(matches(withText("Options")));
