...
* @category: clase
* @Description: Clase que prueba los textos en inglés de la actividad ElegirClaves y prueba que funcionen correctamente
...
public class ElegirClavesPruebasEn {
    ...
    * @Author: Adrián Antón García
    * @category: procedimiento test
    * @Description: Procedimiento que prueba los textos en inglés de la actividad ElegirClaves y prueba que funcionen correctamente
    * las diferentes opciones al pulsar los elementos de la lista de géneros a elegir.
    * */
