...
public class MostrarComparativaPruebasEn {
    ...
    * */
    ...
    public void mostrarComparativaPruebasEs() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.TextView_Comparativa), withText("Comparision between images:"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Comparision between images:")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textView0), withText("Help show comparative activity:"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("Help show comparative activity:")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.textView1), withText("The page shows a comparison between the photo entered and the photo of the selected species,          to enlarge the images click on your photo."),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("The page shows a comparison between the photo entered and the photo of the selected species,          to enlarge the images click on your photo.")));
